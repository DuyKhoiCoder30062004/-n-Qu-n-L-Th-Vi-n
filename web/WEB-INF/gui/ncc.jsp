...
<body>
    <div class="container">
        ...
        <div id="menu" class="sidebar">
            ...
            <button class="detailMenu"><img src="img/nhaxuatban.jpg" alt=""> Nhà xuất bản</button>
            <button id="btncc" class="detailMenu"><img src="img/nhacc.jpg" alt=""> Nhà cung cấp</button>
...
//        click table
            ...
            function sendData(action) {
                ...
                fetch('http://localhost:8080/cnpmweb/ncc_Servlet', {
                    method: 'POST',
