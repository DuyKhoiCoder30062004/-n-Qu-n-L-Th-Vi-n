<%-- 
    Document   : phieunhap
    Created on : Dec 3, 2024, 5:22:54 PM
    Author     : HP
--%>
...
<%
    ...
    if (nv == null || nv.getChucVu().equals("admin")) {
        response.sendRedirect("/web/loginServlet");
        return;
    }
%>
<!DOCTYPE html>
    ...
    <body>
        <form id="form">
            ...
            <div id="menu">
                ...
                <button id="btnSach" class="componentMenu" onclick="reDirect(this, '/web/Sach_Servlets')">
                ...
                <button id="btnNhaCungCap" class="componentMenu" value="nhà cung cấp" onclick="reDirect(this, '/web/ncc_Servlet')">
            ...
            function formatDate(date) {
                ...
                return `${year}-${month}-${day}`;
                    ...
                    function sendDataPN(action) {
                        ...
                        fetch('http://localhost:8080/web/PhieuNhap_Servlet', {
                            method: 'POST',
                    ...
                    function sendDataCTPN(action) {
                        ...
                        fetch('http://localhost:8080/web/CTPNServlet', {
                            method: 'POST',
                            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                            body: formData.toString(),
                        })
